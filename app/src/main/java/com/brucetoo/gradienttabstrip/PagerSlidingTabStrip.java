...
/**
 * 见Line  325 在绘制indicator的时候 加上对应的padding值
 * 源码 来之于  https://github.com/astuetz/PagerSlidingTabStrip/blob/master/library/src/com/astuetz/PagerSlidingTabStrip.java
 */
...
//        tab_bg.setSingleLine();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // default: line below current tab_bg
        View currentTab = tabsContainer.getChildAt(currentPosition);
        float lineLeft = currentTab.getLeft();
        float lineRight = currentTab.getRight();

        // if there is an offset, start interpolating left and right coordinates between current and next tab_bg
        ...
        //make indicator line has same width as TextView so,add tabPadding
